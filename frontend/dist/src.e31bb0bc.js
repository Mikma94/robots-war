...
},{"./bundle-url":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/vue-select/dist/vue-select.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
exports.default = _default;
        var $f35ea8 = exports.default || module.exports;
      
      if (typeof $f35ea8 === 'function') {
        $f35ea8 = $f35ea8.options;
      }
    
        /* template */
        Object.assign($f35ea8, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f35ea8', $f35ea8);
          } else {
            api.reload('$f35ea8', $f35ea8);
          }
        }
...
},{"vue-select/dist/vue-select.css":"../node_modules/vue-select/dist/vue-select.css","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/vue-router/dist/vue-router.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"components/MainMenuComponent.vue":[function(require,module,exports) {
"use strict";
...
var _default = {};
exports.default = _default;
        var $42ced9 = exports.default || module.exports;
      
      if (typeof $42ced9 === 'function') {
        $42ced9 = $42ced9.options;
      }
    
        /* template */
        Object.assign($42ced9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", { staticClass: "title" }, [_vm._v("Robots War")]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c(
          "router-link",
          {
            ...
            attrs: { to: { name: "Game" }, exact: "", tag: "button" }
          },
          [_vm._v("Start")]
        ),
        _vm._v(" "),
        _c(
          ...
          {
            staticClass: "update-button",
            attrs: { to: { name: "CheckLastGames" }, exact: "", tag: "button" }
          },
          [_vm._v(" Check last games")]
        )
      ],
      1
    )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$42ced9', $42ced9);
          } else {
            api.reload('$42ced9', $42ced9);
          }
        }
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/vue-select/dist/vue-select.js":[function(require,module,exports) {
var define;
...
},{}],"../node_modules/vue-select/src/scss/vue-select.scss":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/GameComponent.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    _axios.default.post('http://localhost:8088/api/game', this.game).then(function (response) {
      _this.game = response.data;
    });
  },
  methods: {
    attackToPlayer1: function attackToPlayer1() {
      random = Math.floor(Math.random() * (21 - 5)) + 5;
      this.game.healthPlayer1 - random;
    },
    attackToPlayer2: function attackToPlayer2() {
      random = Math.floor(Math.random() * (21 - 5)) + 5;
...
exports.default = _default;
        var $fafcd8 = exports.default || module.exports;
      
      if (typeof $fafcd8 === 'function') {
        $fafcd8 = $fafcd8.options;
      }
    
        /* template */
        Object.assign($fafcd8, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass: "update-button",
          attrs: { to: { name: "MainMenu" }, tag: "button" }
        },
        [_vm._v("\n    Return to menu\n  ")]
      ),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.game.namePlayer1,
            expression: "game.namePlayer1"
          }
        ],
        staticClass: "form-label",
        domProps: { value: _vm.game.namePlayer1 },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.game, "namePlayer1", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.game.healthPlayer1,
            expression: "game.healthPlayer1"
          }
        ],
        staticClass: "form-health",
        domProps: { value: _vm.game.healthPlayer1 },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.game, "healthPlayer1", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.game.namePlayer2,
            expression: "game.namePlayer2"
          }
        ],
        staticClass: "form-label",
        domProps: { value: _vm.game.namePlayer2 },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.game, "namePlayer2", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.game.healthPlayer2,
            expression: "game.healthPlayer2"
          }
        ],
        staticClass: "form-health",
        domProps: { value: _vm.game.healthPlayer2 },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.game, "healthPlayer2", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fafcd8', $fafcd8);
          } else {
            api.reload('$fafcd8', $fafcd8);
          }
        }
...
},{"axios":"../node_modules/axios/index.js","vue-select":"../node_modules/vue-select/dist/vue-select.js","vue-select/src/scss/vue-select.scss":"../node_modules/vue-select/src/scss/vue-select.scss","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/CheckLastGamesComponent.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    _axios.default.get("http://localhost:8088/api/game").then(function (response) {
  ...
  methods: {
    removeAll: function removeAll() {
      ...
      if (this.games.length <= 0) {
        ...
        _axios.default.delete("http://localhost:8088/api/game").then(function (response) {
          _this2.games = [];
        });
      }
    }
...
exports.default = _default;
        var $3fe5ac = exports.default || module.exports;
      
      if (typeof $3fe5ac === 'function') {
        $3fe5ac = $3fe5ac.options;
      }
    
        /* template */
        Object.assign($3fe5ac, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _c(
        "router-link",
        { attrs: { to: { name: "MainMenu" }, exact: "", tag: "button" } },
        [_vm._v("Return to menu")]
      ),
      _vm._v(" "),
      _c("h1", [_vm._v("Last Games")]),
      _vm._v(" "),
      _vm.games.length
        ? _c(
            "ul",
            _vm._l(_vm.games, function(game) {
              return _c("li", [
                _vm._v(_vm._s(game.id) + "," + _vm._s(game.healthPlayer1))
              ])
            }),
            0
          )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3fe5ac', $3fe5ac);
          } else {
            api.reload('$3fe5ac', $3fe5ac);
          }
        }
...
},{"axios":"../node_modules/axios/index.js","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"router.js":[function(require,module,exports) {
"use strict";
...
var _MainMenuComponent = _interopRequireDefault(require("./components/MainMenuComponent"));

var _GameComponent = _interopRequireDefault(require("./components/GameComponent"));

var _CheckLastGamesComponent = _interopRequireDefault(require("./components/CheckLastGamesComponent"));
...
var _default = new _vueRouter.default({
  routes: [{
    path: '/',
    name: 'MainMenu',
    component: _MainMenuComponent.default
  }, {
    path: '/checkLastGames',
    name: 'CheckLastGames',
    component: _CheckLastGamesComponent.default
  }, {
    path: '/start',
    name: 'Game',
    component: _GameComponent.default
  }]
});

exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vue-router":"../node_modules/vue-router/dist/vue-router.esm.js","./components/MainMenuComponent":"components/MainMenuComponent.vue","./components/GameComponent":"components/GameComponent.vue","./components/CheckLastGamesComponent":"components/CheckLastGamesComponent.vue"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","./router":"router.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
